...
df[outlier_columns[:3]].assign(label=df['label']).boxplot(by="label", figsize=(20, 10))
...
df[outlier_columns[:3]].assign(label=df['label']).plot.hist(by="label", figsize=(20, 10),layout=(3,3))
...
for col in outlier_columns:
    for label in df["label"].unique():
        ...
        # Replace values marked as outliers wit nan
...
#-------------------------------------------------------
outlier_removed_df.to_pickle("E:\Tracking_Barbell_Excercises/data/interim/02_outliers_removed_chauvenets.pkl")